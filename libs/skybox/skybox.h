 ...
 */
inline Skyboxlib SkyboxLoad(const char* ImgSkyboxPath, const char* TextureHDRPath, const char* SkyboxVSPath, const char* SkyboxFSPath, const char* CubemapVSPath, const char* CubemapFSPath) {
...
inline void SkyboxUpdate(Skyboxlib* skybox) {
    if (IsFileDropped()) {
...
inline void DrawSkyboxModel(Skyboxlib* skybox) {
...
inline void DrawSkyboxTexture(Skyboxlib* skybox) {
...
inline void UnloadSkybox(Skyboxlib* skybox) {
